...
parser.add_argument('--npy_path', default="/home/omnisky/ajmq/slideclassify/npy_ncrf", metavar='NPY_PATH', type=str,
...
def run(args):
    ...
    for filename in os.listdir(args.wsi_path):
        slide = openslide.OpenSlide(os.path.join(args.wsi_path, filename))
        ...
        np.save(os.path.join(args.npy_path, filename), tissue_mask)
