...
parser.add_argument('--save_path', default="/home/omnisky/ajmq/patch_slide_relate/save/transformer6.5", metavar='SAVE_PATH', type=str,
...
def run(args):
    ...
    model_crf, model_mil = produce_model_transformer(cfg)
