...
def valid_train_crf(base_dataset, cfg, dataloader_train_crf, loss_fn_with_sigmoid, loss_fn_without_sigmoid, model_crf,
                    summary_train_crf, summary_valid_train_crf):
    time_now = time.time()
    summary_valid_train_crf = valid_epoch_train_crf(summary_valid_train_crf, cfg, model_crf, loss_fn_with_sigmoid,
    ...
    logging.info(
        ...
        'Validation Acc : {:.3f}, Run Time : {:.2f}'
            ...
            summary_train_crf['step'], summary_valid_train_crf['loss'],
            summary_valid_train_crf['acc'], time_spent))


def valid_epoch_train_crf(summary, cfg, model, loss_fn, loss_fn2,
