...
from train_pure_mil.train_gan import *
from train_pure_mil.val_gan import *
from train_pure_mil.val_train_gan import *
import torch
...
parser.add_argument('--cfg_path', default="../../configs/resnet34_new_dataset_whole_structure_pure_mil.json",
                    metavar='CFG_PATH',
                    type=str,
                    help='Path to the config file in json format')
parser.add_argument('--save_path', default="/home/omnisky/ajmq/patch_slide_relate/save_mil", metavar='SAVE_PATH', type=str,
