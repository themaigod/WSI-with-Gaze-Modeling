...
class TransformerForMIL(nn.Module):
    """ A sequence to sequence model with attention mechanism. """
    ...
    #         trg_emb_prj_weight_sharing=True, scale_emb_or_prj='prj'):
    def __init__(
            self, n_trg_vocab=1, d_word_vec=512, d_model=512, d_inner=512, grid_size=9,
            n_layers=1, n_head=8, d_k=64, d_v=64, dropout=0.1, n_position=200,
            trg_emb_prj_weight_sharing=True, scale_emb_or_prj='prj'):
        ...
        self.trg_word_prj = nn.Linear(d_model * grid_size, n_trg_vocab, bias=False)
