...
class GridWSIPatchDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x = int(x * self._slide.level_downsamples[self.level] / self._slide.level_downsamples[0])
        y = int(y * self._slide.level_downsamples[self.level] / self._slide.level_downsamples[0])
        ...
        return (img_flat[0], x_mask, y_mask)
